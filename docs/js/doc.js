...
const docs = [
  ...
  },
  {
    ...
    desc: "Per-session behavior and tools",
  },
  {
    file: "AVAILABLE_SKILLS.md",
    title: "Available Skills",
    desc: "Built-in skills and tools",
  },
  {
    file: "CUSTOM_SKILL.md",
    title: "Custom Skills",
    desc: "Create powerful JavaScript-based skills",
  },
  {
    file: "SCHEDULED_TASKS.md",
    title: "Scheduled Tasks",
    desc: "Cron jobs and timers",
  },
];
...
function loadDocument(filename) {
  ...
  fetch("doc/" + filename)
    ...
    .then((markdown) => {
      ...
      // Apply syntax highlighting to code blocks only (pre > code)
