...
This document specifies the available objects and functions in the sandboxed JavaScript (ES2023) environment used for script execution.
...
None of this methods are asynchrnous, so you can call them directly.
